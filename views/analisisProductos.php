        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-4">
                            <a href="productos_menos_vendidos.php" class="btn btn-outline-warning mr-2" style="color:#E8820C; border-color:#FFE0B2; border-radius:10px;">
                                Productos menos vendidos
                            </a>
                            <!-- Activo: Más vendidos -->
                            <a href="productosviews.php" class="btn btn-danger" style="background-color:#C0392B; border:none; border-radius:10px;">
