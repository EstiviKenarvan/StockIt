      ...
      <div class="container-fluid">
        <div class="row align-items-center mb-4">
          ...
          <div class="col-md-6 text-right d-flex align-items-center justify-content-end">
            ...
            <a href="../views/registro_entrada.php" class="btn" style="background-color: #E8820C; color: white; border-radius: 8px; font-weight: 500; white-space: nowrap; text-decoration: none;">
    + Registrar Entrada
</a>
          </div>
        </div>
