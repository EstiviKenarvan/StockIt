...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?php
$paginaActiva = "index"; // o clientes, reportes, ventas, etc.
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            ...
                                            <a href="?menu=inventario" class="btn btn-lg btn-outline-secondary px-5 ml-2" style="border-radius: 12px;">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
