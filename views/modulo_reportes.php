    ...
    <div class="container-fluid">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-right">
                <button class="btn" style="background-color: #E8820C; color: white; border-radius: 8px; font-weight: bold; padding: 10px 20px;">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="card p-3 shadow-sm" style="border-top: 5px solid #E8820C; border-radius: 10px;">
                    ...
                    <button class="btn btn-sm btn-orange mt-2" style="background-color: #E8820C; color: white; border-radius: 6px;">Ver reporte</button>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-3 shadow-sm" style="border-top: 5px solid #E8820C; border-radius: 10px;">
        ...
        <div class="row mb-4">
            <div class="col-md-7">
                <div class="card p-4 shadow-sm" style="border-radius: 15px; height: 100%;">
                    ...
                    <div class="d-flex align-items-center justify-content-center" style="background-color: #FFF5E5; border: 1px dashed #FFE0B2; border-radius: 12px; height: 200px;">
                        <span class="text-muted">[ Gráfica de línea ]</span>
                    </div>
                ...
                <div class="card p-4 shadow-sm" style="border-radius: 15px; height: 100%;">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between small mb-1">
                            ...
                            <span class="font-weight-bold text-success">132/148</span>
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between small mb-1">
                            ...
                            <span class="font-weight-bold text-warning">18 productos</span>
                        </div>
                        <div class="progress" style="height: 8px; border-radius: 10px;">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between small mb-1">
                            ...
                            <span class="font-weight-bold" style="color: #E8820C;">5 productos</span>
                        </div>
                        <div class="progress" style="height: 8px; border-radius: 10px;">
                            <div class="progress-bar" style="width: 15%; background-color: #E8820C;"></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between small mb-1">
                            <span>Agotados</span>
                            <span class="font-weight-bold text-danger">1 producto</span>
                        </div>
                        <div class="progress" style="height: 8px; border-radius: 10px;">
                        ...
                        <table class="table table-hover m-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Ana López</td>
                                    <td>Febrero 2025</td>
                                    <td><span class="text-primary"><i class="fas fa-file-pdf mr-1"></i> PDF</span></td>
                                </tr>
                                <tr>
                                    <td>25/02/2025</td>
                                    <td>Caducidades</td>
